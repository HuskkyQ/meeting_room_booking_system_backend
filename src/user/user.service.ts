...
export class UserService {
  ...
  async register(user: RegisterUerDto) {
  ...
  async update(userId: number, updateUserDto: UpdateUserDto) {
    ...
    if (updateUserDto.headPhoto) {
      foundUser.headPhoto = updateUserDto.headPhoto;
    }
  ...
  // 解/冻结用户权限
  async freezeUserById(userId: number, isFrozen = true) {
